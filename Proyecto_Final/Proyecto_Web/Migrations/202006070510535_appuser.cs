namespace Proyecto_Web.Migrations
{
    ...
    public partial class appuser : DbMigration
    {
        ...
        {
            DropForeignKey("dbo.Comentaries", "UserId", "dbo.IdentityUsers");
            ...
            AddForeignKey("dbo.Comentaries", "UserId", "dbo.AspNetUsers", "Id", cascadeDelete: true);
        ...
        public override void Down()
        {
            ...
            AddForeignKey("dbo.Comentaries", "UserId", "dbo.IdentityUsers", "Id", cascadeDelete: true);
        }
    }
}
