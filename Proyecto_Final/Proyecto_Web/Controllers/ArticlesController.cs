...
namespace Proyecto_Web.Controllers
{
    public class ArticlesController : Controller
    {
        ...
        {
            ViewBag.AuthorId = new SelectList(db.Authors, "Id", "Description");
        ...
        public ActionResult Create([Bind(Include = "Id,Title,CategoryId,Description,Content,ImgUrl,AuthorId")] Article article)
        {
            ...
            ViewBag.AuthorId = new SelectList(db.Authors, "Id", "Description", article.AuthorId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,CategoryId,Description,Content,Posted,ImgUrl,AuthorId")] Article article)
        {
            if (ModelState.IsValid)
            {
